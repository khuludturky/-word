document.addEventListener("DOMContentLoaded", () => {
  ...
  let fonts = ["New Tegomin", "Roboto", "lato","Zen Dots"];
  let content = `<div class="container">
      <h1 class="title">Projet Développement Web </h1>
      <div class="form__contaier">
        <form action="#" id="form">
          <input type="color" name="color" value="#d86c51"  id="color" />
          <input type="number" type="number" value="55"  id="size" />
